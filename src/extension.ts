...
// more info on how to develop vscode debugger extension
...
export function activate(context: vscode.ExtensionContext): void {
    ...
    // hover over the function. This one register the launch.json `type`, register `bashdb` into `type` there
    // when you start debugging, this line will run, can set breakpoint here
...
// i think this class is just to setup the config variable to be used by debugger
// can set breakpoint here, to trigger here, start the debugging in the popped up window after you start this extension's debugging
